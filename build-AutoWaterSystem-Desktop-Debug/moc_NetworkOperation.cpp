...
QT_MOC_LITERAL(3, 21, 11)
    ...
    "ThreadGET\0threadLog\0\0textMessage"
};
#undef QT_MOC_LITERAL
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ThreadGET *_t = static_cast<ThreadGET *>(_o);
        switch (_id) {
        case 0: _t->threadLog((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (ThreadGET::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ThreadGET::threadLog)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void ThreadGET::threadLog(QString _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
    QMetaObject::activate(this, &staticMetaObject, 0, _a);
}
